...
TRANSLATIONS = {
    "ru": {
        ...
        "edit_active_order": "Изменить текущий заказ",
        "edit_order_loaded": "Открыла твой текущий заказ. Можно скорректировать до закрытия приема.",
        "order_change_hint": "До закрытия приема можно изменить уже отправленный заказ.",
        ...
        "group_schedule_none": "Напоминание по группе: не настроено",
        "group_schedule_set": "Напоминание по группе: {day} {time}",
        "group_schedule_prompt": "Отправь время напоминания для группы в формате MON 09:30 или OFF, чтобы отключить.",
        "group_schedule_saved": "Расписание напоминания для группы сохранено.",
        "group_schedule_cleared": "Расписание напоминания для группы отключено.",
        "group_schedule_invalid": "Нужен формат MON 09:30 или OFF.",
        ...
        "admin_updated_order": "Обновленный заказ от {name}:",
    ...
    "es": {
        ...
        "edit_active_order": "Editar pedido actual",
        "edit_order_loaded": "He cargado tu pedido actual. Puedes ajustarlo antes del cierre.",
        "order_change_hint": "Antes del cierre puedes cambiar un pedido ya enviado.",
        ...
        "group_schedule_none": "Recordatorio de grupo: no configurado",
        "group_schedule_set": "Recordatorio de grupo: {day} {time}",
        "group_schedule_prompt": "Envia el horario del recordatorio como MON 09:30 o OFF para desactivarlo.",
        "group_schedule_saved": "Horario de recordatorio del grupo guardado.",
        "group_schedule_cleared": "Horario de recordatorio del grupo desactivado.",
        "group_schedule_invalid": "Usa el formato MON 09:30 o OFF.",
        ...
        "admin_updated_order": "Pedido actualizado de {name}:",
